  ...
  const LayoutManager = {
    ...
    syncCurrentToMaster() {
      ...
      this.items.forEach(item => {
        ...
        const isCenterTool = ['gcp-object', 'gcp-copy', 'gcp-copy-2', 'gcp-copy-3', 'spanner-object', 'gdrive-object', 'gdrive-copy-2', 'ace-object', 'adk-object', 'adk-copy', 'salesforce-object', 'moma-object', 'buganizer-object'].includes(item.elementId);
  ...
  class DynamicBeltApp {
    ...
    drawDataConduits(ctx, timestamp) {
      ...
      if (skillsEl) {
        ...
        // 2b. Jetski Skills (Bottom) -> Marina Wheel: "Totum Local Curator"
        if (pMarinaLeft) {
          this.drawCurvedSkillConduit(ctx, pSkillsBottom, pMarinaLeft, 'Totum Local Curator', timestamp, {
            reverseBulge: true,
            tPipe: 0.48,
            curveRatio: 0.18
          });
      ...
      if (skillsRightEl) {
        ...
        // 4b. Right Jetski Skills (Bottom) -> Right Marina Wheel: "Totum Local Curator"
        if (pMarinaRight) {
          this.drawCurvedSkillConduit(ctx, pSkillsRightBottom, pMarinaRight, 'Totum Local Curator', timestamp, {
