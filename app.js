  ...
  const LayoutManager = {
    ...
    syncCurrentToMaster() {
      ...
      this.items.forEach(item => {
        ...
        const isCenterTool = ['gcp-object', 'gcp-copy', 'gcp-copy-2', 'gcp-copy-3', 'spanner-object', 'gdrive-object', 'gdrive-copy-2', 'ace-object', 'adk-object', 'adk-copy', 'salesforce-object', 'moma-object'].includes(item.elementId);
