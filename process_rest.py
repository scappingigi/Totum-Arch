...
def make_rest_transparent(input_path, output_path):
    ...
    print(f"Successfully processed Rest PNG: {output_path} ({len(res)} bytes)")

if __name__ == '__main__':
    make_rest_transparent('/Users/scappin/Src/ACE/Rest_raw.png', '/Users/scappin/Src/ACE/Rest.png')
