...
def make_adk_transparent(input_path, output_path):
    ...
    for y in range(h):
        ...
        for x in range(w):
            ...
            # If pixel is white / light neutral grey
            if lum >= 235 and max_diff < 30:
                a = 0
            elif lum > 190 and max_diff < 30:
                t = (235 - lum) / 45.0
    ...
    print(f"Saved transparent ADK image: {output_path}")

if __name__ == '__main__':
    make_adk_transparent('/Users/scappin/Src/ACE/ADK.png', '/Users/scappin/Src/ACE/ADK.png')
